...
public class PubnubTestActivity extends Activity {
	...
	Pubnub pubnub;
	String myMessage = "", channel = "my_channel";
	EditText ed;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String S = "<sender><sent>Computer Parts</sent><PART><status>Motherboard</status><areaDesc>ASUS</areaDesc><location>P3B-F</location><COST> 123.00</COST></PART></sender>";
		String SS = "<?xml version = \"1.0\" encoding = \"UTF-8\"?>"
                + "<alert xmlns = \"urn:oasis:names:tc:emergency:cap:1.2\">"
+"<sender>bruce@pubnub.gov</sender>"
                +"<sent>"
                +y+"-"+m+"-"+dd+"T"+h+":"+mm+"-"+s+"05:00"
                +"</sent>"
                ...
                + "</area>"
                +"<location>23.692811,120.53413</location>"
                +"</info>"
                +"</alert>";
		...
		// Android: (Init)
		pubnub = new Pubnub("pub-348e8d2c-b9b9-47f6-9553-552f316feb90", // PUBLISH_KEY
				"sub-a02493fa-32eb-11e2-9b65-fdd4b614f582",          // SUBSCRIBE_KEY
				"",          // SECRET_KEY
				"",              // CIPHER_KEY
				true             // SSL_ON?
		);
	...
	public void allMessageClick(View v) {
		JSONObject message = new JSONObject();
		try {
			message.put("some_val", "Hello World! --> �憿詔#$%^&*()!");
			/*
